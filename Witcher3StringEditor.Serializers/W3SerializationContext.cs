...
/// <summary>
///     Represents the context information required for W3 serialization operations
///     This record contains all the necessary parameters and settings needed to serialize W3 string items
/// </summary>
public record W3SerializationContext
{
    ...
    ///     This determines the format in which the W3 string items will be serialized (e.g., CSV, Excel, W3Strings)
    ///     This is a required property that must be specified during context creation
    /// </summary>
    ...
    ///     This specifies the language that the W3 string items are in or should be translated to
    ///     This is a required property that must be specified during context creation
    /// </summary>
    public required W3Language TargetLanguage { get; init; }

    /// <summary>
    ///     Gets the expected ID space for the W3 string items
