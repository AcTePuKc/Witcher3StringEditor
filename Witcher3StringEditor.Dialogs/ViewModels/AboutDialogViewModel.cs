...
/// </summary>
/// <param name="aboutInfo">A dictionary containing information to display in the about dialog</param>
public class AboutDialogViewModel(IReadOnlyDictionary<string, object?> aboutInfo)
    : ObservableObject, IModalDialogViewModel
{
    /// <summary>
    ///     Gets the dictionary containing information to display in the about dialog
    /// </summary>
